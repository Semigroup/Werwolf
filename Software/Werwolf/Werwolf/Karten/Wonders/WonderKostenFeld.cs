...
namespace Werwolf.Karten
{
    public class WonderKostenFeld : WonderTextFeld
    {
        ...
        public WonderKostenFeld(Karte Karte, float Ppm)
            : base(Karte, Ppm, true, Karte.Universe.TextBilder["KleinesNamenfeld"])
        {
        ...
        public override void OnKarteChanged()
        {
            ...
            else
            {
                ...
                if (!Kosten.Equals(LastKosten))
                {
                    ...
                    Text[] KostenText = Karte.Kosten.ProduceTexts(Karte.TitelDarstellung.FontMeasurer);
                    if (KostenText.Length > 0)
                        DrawBox = KostenText[0];
                    else
                        DrawBox = null;
                    DrawBoxChanged = true;
                }
